...
public class WeatherProvider extends ContentProvider {
    ...
    public int update(
        ...
        switch (match) {
            case WEATHER:
                rowsUpdated = db.delete(WeatherContract.WeatherEntry.TABLE_NAME, selection, selectionArgs);
                break;
            case LOCATION:
                rowsUpdated = db.delete(WeatherContract.LocationEntry.TABLE_NAME, selection, selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
