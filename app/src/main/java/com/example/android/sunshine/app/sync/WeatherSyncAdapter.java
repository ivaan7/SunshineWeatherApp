...
public class WeatherSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            final String APPID_VALUE = "6017cad5639f35795f21f15be367e79a";
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if (cVVector.size() > 0) {
                ...
                //delete old weather data so it is not any more in apps internal memory
                // deleting data that is older than one day
    ...
    //helper method for setting the location status used above to shared preferences
    private static void setLocationStatus(Context context, @LocationStatus int locationStatus) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putInt(context.getString(R.string.prefLocationStatusKey), locationStatus);
        editor.commit();
    }
